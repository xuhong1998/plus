...
Page({
    ...
    HttpRequest:function(user,passward){
      ...
      console.log('https://xuchaoyang.cn/Loginweb/LoginServlet?userName=' + user + '&userpassword=' + passward)
      wx.request({
        url: 'https://xuchaoyang.cn/Loginweb/LoginServlet?userName='+ user +'&userpassword='+ passward,
        data: {},
        header: {
        ...
        success: function (res) {
          ...
          res.data[user].ScoreList.shift();
          res.data[user].Project.shift();
          ScoreList = res.data[user].ScoreList;
